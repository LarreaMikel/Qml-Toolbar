...
UBUNTU_TRANSLATION_DOMAIN="qml-toolbar.larreamikel"
...
aptest.commands = bash $$PWD/Qml-Toolbar/tests/autopilot/run
aptest.depends  = sub-Qml-Toolbar

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-Toolbar/tests/unit 
unittest.depends  = sub-Qml-Toolbar
